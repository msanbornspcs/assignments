...
![Final canvas with Process Type: Sequential visible at top-left](screenshots/Screenshot%202.png)
...
![Human Approval task panel showing Description, Expected Output, and Guardrail fields](screenshots/Screenshot%203.png)
...
![Run tab Timeline showing completed task entries for multiple agents](screenshots/Screenshot%204.png)
